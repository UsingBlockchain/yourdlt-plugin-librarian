 ...
 */
export class MosaicDefinition extends Generator {
    ...
    public getSentence(): string {
        ...
        const divisibility = this.transaction.divisibility;
        return `created the asset ${mosaicId.toHex()} with divisibility of ${divisibility}`;
    }
